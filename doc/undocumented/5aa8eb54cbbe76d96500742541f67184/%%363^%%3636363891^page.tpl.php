...
images/Page_logo.png" alt="File" style="vertical-align: middle"><?php echo $this->_tpl_vars['source_location']; ?>
</h2>
...
images/<?php if ($this->_tpl_vars['classes'][$this->_sections['classes']['index']]['abstract']): ?>Abstract<?php endif;  if ($this->_tpl_vars['classes'][$this->_sections['classes']['index']]['access'] == 'private'): ?>Private<?php endif; ?>Class.png"
