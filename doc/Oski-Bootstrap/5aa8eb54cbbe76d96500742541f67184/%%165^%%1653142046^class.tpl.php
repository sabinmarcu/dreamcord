<?php /* Smarty version 2.6.0, created on 2011-07-05 18:33:15
...
images/<?php if ($this->_tpl_vars['abstract']):  if ($this->_tpl_vars['access'] == 'private'): ?>AbstractPrivate<?php else: ?>Abstract<?php endif;  else:  if ($this->_tpl_vars['access'] == 'private'): ?>Private<?php endif;  endif;  if ($this->_tpl_vars['is_interface']): ?>Interface<?php else: ?>Class<?php endif; ?>_logo.png"
...
images/<?php if ($this->_tpl_vars['children'][$this->_sections['kids']['index']]['abstract']): ?>Abstract<?php endif;  if ($this->_tpl_vars['children'][$this->_sections['kids']['index']]['access'] == 'private'): ?>Private<?php endif; ?>Class.png"
...
?>
				...
				<div class="var-title">
					<img src="<?php echo $this->_tpl_vars['subdir']; ?>
images/<?php if ($this->_tpl_vars['vars'][$this->_sections['vars']['index']]['access'] == 'private'): ?>PrivateVariable<?php else: ?>Variable<?php endif; ?>.png" alt=" " />
...
?>
				...
				<div class="method-definition">
					<img src="<?php echo $this->_tpl_vars['subdir']; ?>
images/<?php if ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['constructor']): ?>Constructor<?php elseif ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['destructor']): ?>Destructor<?php elseif ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['access'] == 'private'):  if ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['abstract']): ?>Abstract<?php endif; ?>PrivateMethod<?php else:  if ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['abstract']): ?>Abstract<?php endif; ?>Method<?php endif; ?>.png" alt=" "/>
					<a href="#<?php echo $this->_tpl_vars['methods'][$this->_sections['methods']['index']]['function_name']; ?>
" title="details" class="method-name"><?php if ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['returnsref']): ?>&amp;<?php endif;  echo $this->_tpl_vars['methods'][$this->_sections['methods']['index']]['function_name']; ?>
</a>
					<?php if (count ( $this->_tpl_vars['methods'][$this->_sections['methods']['index']]['ifunction_call']['params'] )): ?>
...
?>
							<img src="<?php echo $this->_tpl_vars['subdir']; ?>
images/<?php if ($this->_tpl_vars['ivars'][$this->_sections['ivars']['index']]['ivars'][$this->_sections['ivars2']['index']]['access'] == 'private'): ?>PrivateVariable<?php else: ?>Variable<?php endif; ?>.png" />
...
?>
							<img src="<?php echo $this->_tpl_vars['subdir']; ?>
images/<?php if ($this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['constructor']): ?>Constructor<?php elseif ($this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['destructor']): ?>Destructor<?php elseif ($this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['access'] == 'private'):  if ($this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['abstract']): ?>Abstract<?php endif; ?>PrivateMethod<?php else:  if ($this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['abstract']): ?>Abstract<?php endif; ?>Method<?php endif; ?>.png" alt=" "/>
...
?>
							<img src="<?php echo $this->_tpl_vars['subdir']; ?>
images/<?php if ($this->_tpl_vars['iconsts'][$this->_sections['iconsts']['index']]['iconsts'][$this->_sections['iconsts2']['index']]['access'] == 'private'): ?>PrivateVariable<?php else: ?>Variable<?php endif; ?>.png" />
