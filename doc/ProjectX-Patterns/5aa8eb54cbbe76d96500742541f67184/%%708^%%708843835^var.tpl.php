...
<a name="<?php echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_name']; ?>
...
images/<?php if ($this->_tpl_vars['vars'][$this->_sections['vars']['index']]['access'] == 'private'): ?>PrivateVariable<?php else: ?>Variable<?php endif; ?>.png" />
